...
def run(screen, playerBike, computerBikes, Race_Length):
   ...
   while running:
      ...
      #pygame.draw.rect(screen, black, (197, 48, 106, 24)) 
      #pygame.draw.rect(screen, green, (200, 50, aerobarlength, 20)) 
...
def main():
   ...
   while True:
      playerBike = Bike(1, "Player", 6000, 0, 0)
      computerBike1 = Bike(2, "Chris Frome", 7500, 1000, 0)
      computerBike2 = Bike(3, "Peter Sagan", 7000, 2500, 0)
      computerBike3 = Bike(4, "Geraint Thomas", 6000, 1000, 0)
      computerBike4 = Bike(5, "Vincenzo Nibali", 8000, 1000, 0)
