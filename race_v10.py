...
def main():
   ...
   while True:
      ...
      computerBike5 = Bike(5, "Tadej Pogacar", 8500, 1000, 0, random.randint(0, raceLength), 5000, 1000)
      computerBike6 = Bike(6, "Mathieu vd Poel", 8800, 1000, 0, random.randint(0, raceLength), 5000, 1000)
      playerBike = Bike(7, "Player", 7000, 0, 0, 0, 0, 0)
