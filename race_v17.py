...
#      v16 : changes for python3
#      v17 : add strava upload
   ...
   while nochoice==True: 
      ...
      for ev in pygame.event.get(): 
         ...
         if ev.type == pygame.MOUSEBUTTONDOWN: 
            ...
            if 190 <= mouse[0] <= 620 and 150 <= mouse[1] <= 180:
               choice = listCourses[0]
               nochoice = False

            if 190 <= mouse[0] <= 620 and 200 <= mouse[1] <= 230: 
               choice = listCourses[1]
               nochoice = False 

            if 190 <= mouse[0] <= 620 and 250 <= mouse[1] <= 280: 
               choice = listCourses[2]
               nochoice = False 

            if 190 <= mouse[0] <= 620 and 300 <= mouse[1] <= 330: 
               choice = listCourses[3]
               nochoice = False 

            if 190 <= mouse[0] <= 620 and 350 <= mouse[1] <= 380: 
               choice = listCourses[4]
               nochoice = False 

            if 190 <= mouse[0] <= 620 and 400 <= mouse[1] <= 430: 
               choice = listCourses[5]
               nochoice = False 

         if 190 <= mouse[0] <= 620 and 150 <= mouse[1] <= 180:
            pygame.draw.rect(screen,color_light,[190,150,430,30])
         else:
            pygame.draw.rect(screen,color_dark,[190,150,430,30])

         if 190 <= mouse[0] <= 620 and 200 <= mouse[1] <= 230:
            pygame.draw.rect(screen,color_light,[190,200,430,30])
         else:
            pygame.draw.rect(screen,color_dark,[190,200,430,30])

         if 190 <= mouse[0] <= 620 and 250 <= mouse[1] <= 280:
            pygame.draw.rect(screen,color_light,[190,250,430,30])
         else:
            pygame.draw.rect(screen,color_dark,[190,250,430,30])

         if 190 <= mouse[0] <= 620 and 300 <= mouse[1] <= 330:
            pygame.draw.rect(screen,color_light,[190,300,430,30])
         else:
            pygame.draw.rect(screen,color_dark,[190,300,430,30])

         if 190 <= mouse[0] <= 620 and 350 <= mouse[1] <= 380:
            pygame.draw.rect(screen,color_light,[190,350,430,30])
         else:
            pygame.draw.rect(screen,color_dark,[190,350,430,30])

         if 190 <= mouse[0] <= 620 and 400 <= mouse[1] <= 430:
            pygame.draw.rect(screen,color_light,[190,400,430,30])
         else:
            pygame.draw.rect(screen,color_dark,[190,400,430,30])


      screen.blit(write(listCourses[0], size=48), (200,150))
      screen.blit(write(listCourses[1], size=48), (200,200))
      screen.blit(write(listCourses[2], size=48), (200,250))
      screen.blit(write(listCourses[3], size=48), (200,300))
      screen.blit(write(listCourses[4], size=48), (200,350))
      screen.blit(write(listCourses[5], size=48), (200,400))
...
def StravaOption(screen):
   stravaoption = pygame.image.load("/home/pi/bike/stravaoption.gif").convert()
   screen.blit(stravaoption, (200,200))
...
def StravaUpload(screen, gpxfile):

   choice = StravaOption(screen)
...
def main():
   ...
   while True:
      ...
      computerBike1 = Bike(1, "Chris Frome", ineosbike, 800, 2000, 0, random.randint(0, raceLength), 500, 1000)
      computerBike2 = Bike(2, "Peter Sagan", borabike, 810, 3000, 0, random.randint(0, raceLength), 500, 1000)
      computerBike3 = Bike(3, "Geraint Thomas", ineosbike, 820, 1000, 0, random.randint(0, raceLength), 500, 1000)
