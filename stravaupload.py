...
def refresh_access_token():
    ...
    cid = 99170 # CLIENT_ID from stravacli
    client_secret = "855bdee25642ba8a5f7e92e18879727e03c5835a"
    ...
    with open('strava_tokens_new.json', 'w') as outfile:
