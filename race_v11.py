...
def GetRaceLength(screen):
   ...
   while nochoice==True: 
      ...
      screen.blit(write("15 km", size=48), (400,350))
...
def run(screen, playerBike, computerBikes, Race_Length, RaceStartTime):
   ...
   while running:
      ...
      leaderboard = GetLeaderboard(playerBike, computerBikes)
      DrawLeaderboard(screen, leaderboard, 500, 320)
...
def main():
   ...
   while True:
      ...
      playerBike = Bike(7, "Player", redbike, 7000, 0, 0, 0, 0, 0)

      computerBikes = [ computerBike1, computerBike2, computerBike3, computerBike4, computerBike5, computerBike6]

      raceStartTime = time.time()
      run(screen, playerBike, computerBikes, raceLength, raceStartTime)
